...
class TravelOrderDetail extends StatelessWidget {
  static const routeName = 'travel-order-detail.dart';
  @override
  Widget build(BuildContext context) {
    return BlocConsumer<OrderBloc, OrderState>(
      listener: (context, state) {
        state.travelOrderOption.fold(
              () => null,
              (either) => either.fold(
        ...
        if (state.travelOrder.status == 'ACCEPTED') {
          FlushbarHelper.createSuccess(
              message: 'Order is accepted please make payment to continue')
              .show(context);
        } else if (state.travelOrder.status == 'DENIED') {
          FlushbarHelper.createError(
            message: 'Request timeout try again',
          ).show(context);
        } else if (state.travelOrder.status == 'REQUESTING') {
      ...
      builder: (context, state) {
        ...
        return Scaffold(
          ...
          body: state.travelOrder.status == 'REQUESTING' || state.loading
              ? SimpleDialog(
                ...
                ListView(
                  children: <Widget>[
                    ...
                    cartOrderItemListTile(
                        'images/ic_veg.png',
                        context,
                        state.travelOrder.foodName,
                        FormatData().formatCurrency(state.travelOrder.price),
                        state.travelOrder.quantity,
                    ...
                    Container(
                      ...
                      child: Row(
                          ...
                          children: <Widget>[
                            ...
                            Text(
                              ' ${FormatData().formatCurrency(state.travelOrder.price)} TZS',
                              style: Theme.of(context).textTheme.caption,
                            ),
                          ]),
                    ),
                    ...
                    Container(
                      ...
                      child: Row(
                          ...
                          children: <Widget>[
                            ...
                            Text(
                              '${FormatData().formatCurrency(double.parse('0'))} TZS',
                              style: Theme.of(context).textTheme.caption,
                            ),
                          ]),
                    ),
                    ...
                    Container(
                      ...
                      child: Row(
                          ...
                          children: <Widget>[
                            ...
                            Text(
                              '${FormatData().formatCurrency(state.travelOrder.price + 0)} TZS',
                              style: Theme.of(context).textTheme.caption,
                            ),
                          ]),
                    ),
                ...
                Align(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      BottomBar(
                        text: 'Pay' + " ${FormatData().formatCurrency(state.travelOrder.price + 0)} TZS",
                        onTap: () =>
